...
public class MenuPane extends LayeredPane {
	...
	/**
	 * Adds all buttons in the current menu set to the palette layer. Can now also specify where on the screen 
	 * each button should go. Includes an algorithm to place new buttons as the space gets smaller vertically, runs to a max amount of buttons
	 * @param buttons
	 */
	private void createBtns(String[] buttons){
		...
		//make main menu if farthest back
		else{
	...
	/**
	 * Determines the y value of where the cascading buttons should be placed on the screen based 
	 * on how many buttons are present in the current menu. Will try to space evenly
	 * @param btnCount
	 * @return
	 */

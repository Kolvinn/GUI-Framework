...
/**
 * ImagePanel is an extension of JPanel which primarily will replace objects such as JButtons etc, it allows for 
 * much greater freedom to create differing interactive objects on the panel
 * @author Jeremy
 *
 */
